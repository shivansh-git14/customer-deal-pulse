-- ==========================================
-- CORRECTLY DROP AND RECREATE WITH CALCULATION DETAILS
-- ==========================================
-- Purpose: Add raw calculation values to working function (requires DROP then CREATE)
-- Date: 2025-08-10
-- Fix: PostgreSQL cannot change return type - must DROP FUNCTION first
-- ==========================================
