-- ==========================================
-- FIX CUSTOMER HERO METRICS VALUES
-- ==========================================
-- Purpose: Update function with correct at-risk and revenue category values
-- Date: 2025-08-10
-- Issue: At-risk rate and repeat revenue showing 0 - likely wrong values
-- Strategy: Check multiple possible values that might exist in data
-- ==========================================

-- Update customer hero metrics function with corrected values
...
BEGIN
    ...
    at_risk_customers AS (
        -- Calculate at-risk customers - try multiple possible values
        ...
        SELECT 
            -- Try multiple possible at-risk values
    ...
    revenue_analysis AS (
        -- Calculate repeat revenue rate - try multiple possible values
        WITH customer_revenue_summary AS (
            SELECT 
                cu.customer_id,
                -- Try multiple possible repeat revenue categories
